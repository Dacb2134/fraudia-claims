...
CREATE TABLE IF NOT EXISTS polizas (
    ...
    ramo           VARCHAR(20) NOT NULL DEFAULT 'Generales',
...
CREATE TABLE IF NOT EXISTS proveedores (
    ...
    tipo                        VARCHAR(30) NOT NULL DEFAULT 'Taller',
    ciudad                      VARCHAR(80)  NOT NULL DEFAULT 'Quito',
...
CREATE TABLE IF NOT EXISTS siniestros (
    ...
    estado                          VARCHAR(30) NOT NULL DEFAULT 'Reserva',
...
CREATE TABLE IF NOT EXISTS documentos (
    ...
    tipo_documento           VARCHAR(40) NOT NULL DEFAULT 'Denuncia Policial',
